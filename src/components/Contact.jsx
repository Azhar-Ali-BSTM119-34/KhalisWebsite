...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "azharaliworkspace1234@gmail.com",
      ...
      .then(
        ...
        (error) => {
          ...
          alert(
            "Your order could not be placed. Please contact us on this number +92 327 7448801. Thank you."
          );
        }
      );
  };
  ...
  return (
    <div
      className={`xl:mt-12 mb-52 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden mx-0.5 m-auto`}
    >
      <motion.div
        variants={slideIn("", "tween", 0.2, 1)}
        className="flex-[0.75]  bg-sky-500 backdrop-filter backdrop-blur-3xl p-8 rounded-2xl"
      >
